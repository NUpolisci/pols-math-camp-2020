...
.med[Imagine that you are creating a simple additive index of 3 indicators: per capita income, percent of housing crowded, and percent without diploma. Create a new variable with the sum of these values and divide it by 3.]
...
2) Create a new dataset that only has North Side neighborhoods and were per capita income is above $40,000.
...
---
# PRACTICE `r emo::ji("geek")`

Using the World Value Survey dataset from yesterday: 
