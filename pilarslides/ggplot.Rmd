...
3) Make a violin plot of the distribution of "income_eq" for each country (same plot). 

4) Make a box plot of the distribution of "just_abort" for each country (same plot).  
